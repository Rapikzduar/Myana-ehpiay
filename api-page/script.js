document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Myana-kyu-tyawu-API");
        setContent('header', 'textContent', settings.name || "Myana-kyu-tyawu-API");
        setContent('name', 'textContent', settings.name || "Myana-kyu-tyawu-API");
        setContent('version', 'textContent', settings.version || "1");
